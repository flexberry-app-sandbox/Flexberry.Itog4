...
namespace IIS.Itog4
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog4.Статус fСтатус;
        
        private IIS.Itog4.ТипДоговора fТип;
        
        private int fДлительность;
        
        private int fСтоимость;
        
        private IIS.Itog4.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.Itog4.Клиент fКлиент;
        ...
        public virtual IIS.Itog4.Статус Статус
        {
            get
            {
                ...
                IIS.Itog4.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog4.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog4.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog4.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog4.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog4.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog4.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog4.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog4.Договор));
                }
            }
        }
    }
