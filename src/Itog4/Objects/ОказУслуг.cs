...
namespace IIS.Itog4
{
    ...
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog4.Услуги fУслуги;
        
        private IIS.Itog4.Договор fДоговор;
        
        private IIS.Itog4.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.Itog4.Договор Договор
        {
            get
            {
                ...
                IIS.Itog4.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Itog4.Услуги Услуги
        {
            get
            {
                ...
                IIS.Itog4.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Itog4.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.Itog4.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.Itog4.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.Itog4.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Itog4.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.Itog4.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.Itog4.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.Itog4.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.Itog4.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Itog4.ОказУслуг dataobject)
        {
